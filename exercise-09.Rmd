...
num <- sum(residuals^2)
den <- sum((df$Group_size - mean(df$Group_size))^2) * (n - 2)  #WHY NOT WORKING. error message: Error in n - 2 : non-numeric argument to binary operator
```
...
SE_b1 <- sqrt(num/den) # den wrong bc not working above
SE_b1
