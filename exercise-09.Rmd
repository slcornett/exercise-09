...
#directly getting p_value, not sure why it is different from the boot_p_value
boot.p.value <- boot_slope %>%
  get_p_value(obs_stat = og_slope$estimate, direction="two_sided")
boot.p.value
```
